...
//                customAdapter = CustomAdapter(contactArray,names,imgList)
        ...
        floatingActionButton.setOnClickListener {
            val dialog = Dialog(this@profile)
                    ...
                    ref1.child(s).addListenerForSingleValueEvent(object : ValueEventListener {
                        override fun onDataChange(commonSnapshot: DataSnapshot) {
                            if (commonSnapshot.exists()) {
                                ...
                                Toast.makeText(this@profile, "Item with name $s already exists. Please choose another name for this item", Toast.LENGTH_SHORT).show()
                            } else {
...
//                                imgList.add(R.drawable.plus)
                                ...
                                customAdapter.notifyItemInserted(contactArray.size - 1)
                                Toast.makeText(this@profile, "Item with name $s posted successfully!", Toast.LENGTH_SHORT).show()
                        ...
                        override fun onCancelled(databaseError: DatabaseError) {
                            // Handle errors here
                            Toast.makeText(this@profile, "Error: ${databaseError.message}", Toast.LENGTH_SHORT).show()
                        }
                    })
                }
            }
...
//            customAdapter.notifyItemInserted(contactArray.size-1)
        ...
        customAdapter.setOnClickListener(object : CustomAdapter.OnClickListener{
            override fun onItemClick(position: Int) {
                ...
                var intent = Intent(this@profile, aaActivity::class.java)
...
//                        Log.w(TAG, "Database error: ${databaseError.toException()}")
        ...
        customAdapter.setOnLongClickListener(object : CustomAdapter.OnLongClickListener {
            override fun onItemLongClick(position: Int) {
                val alertDialogBuilder = AlertDialog.Builder(this@profile)
                ...
                alertDialogBuilder.setPositiveButton("Yes") { dialog, which ->
                    ...
                    if(position >= 0 && position < names.size){
                        ...
                        Toast.makeText(this@profile, "Item Deleted successfully !!", Toast.LENGTH_SHORT).show()
